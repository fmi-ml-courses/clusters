...
- Уровень: магистратура, продвинутый курс по машинному обучению.[1]
- Формат: 12 лекций (по теории и методам) + 12 практик (Python, sklearn, umap‑learn, реалистичные датасеты).[2][3]
- Итоговая оценка: групповой или индивидуальный проект по применению методов понижения размерности и кластеризации к реальным данным.[4][5]
